    ...
    >
      <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form @submit.prevent="generateToken" class="space-y-3">
          <input v-model="card.number" type="text" placeholder="Número de tarjeta" class="input" required />
          <div class="flex gap-2">
            <input v-model="card.exp_month" type="text" placeholder="Mes (MM)" class="input" required />
            <input v-model="card.exp_year" type="text" placeholder="Año (YY)" class="input" required />
          </div>
          <input v-model="card.cvc" type="text" placeholder="CVC" class="input" required />
          <input v-model="card.card_holder" type="text" placeholder="Titular" class="input" required />
